/**
 * Fichier custom issu du ominves Datatables
 * Permet de rajouter des paramètres via ajax à la requete posté via le code ajouté ligne 32.
 *
 var req = {};
 if (options.ajax !== undefined && {}.toString.call(options.ajax.data) === '[object Function]') {
            options.ajax.data(req);
 }
